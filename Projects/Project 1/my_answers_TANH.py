...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # as shown below.
        self.activation_function = lambda x : (np.exp(2*x) - 1) / (np.exp(2*x) + 1)  # Replace 0 with your sigmoid calculation.
    ...
    def forward_pass_train(self, X):
        ...
        final_outputs = final_inputs # signals from final output layer using the activation function of the output that is f(x) = x
